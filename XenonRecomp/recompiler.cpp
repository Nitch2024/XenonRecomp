    ...
    CSRState& csrState)
{
    ...
    case PPC_INST_VMAXUB: // DOUBLE CHECK
        println("\t_mm_store_si128((__m128i*){}.u8, _mm_max_epu8(_mm_load_si128((__m128i*){}.u8), _mm_load_si128((__m128i*){}.u8)));",
            v(insn.operands[0]), v(insn.operands[1]), v(insn.operands[2]));
        break;
    ...
    case PPC_INST_VSLO128: // DOUBLE CHECK
    case PPC_INST_VSLO:
        printSetFlushMode(true);
